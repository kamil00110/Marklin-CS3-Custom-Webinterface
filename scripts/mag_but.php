...
if ($data3) {
    ...
    if (json_last_error() === JSON_ERROR_NONE) {
        ...
        $state = htmlspecialchars($jsonData3['none'] ?? 'None');
    } 
	else {
        echo "Failed to decode JSON data.";
    }
	if ($state==0){
		echo "<button class='button' style='width=200px;' onclick='change(\"mags.php\")''>  
              ...
              <text  font-weight='bold' x='12' y='30' fill='gray' font-family='Arial' font-size='18' text-anchor='start' dominant-baseline='hanging'>Mag</text>
              </svg>
	          </div>
			  </button>";
	}
		...
		echo "<button class='button' style='width=200px;' onclick='change(\"mags.php\")''>  
              ...
              xmlns='http://www.w3.org/2000/svg'>
              <rect x='6' y='6' width='60' height='60' rx='12' fill='#f7f7f7' stroke='#4f4f4f' stroke-width='2'/>
              <text  font-weight='bold' x='12' y='30' fill='grey' font-family='Arial' font-size='18' text-anchor='start' dominant-baseline='hanging'>Mag</text>
              </svg>
	          </div>
			  </button>";
